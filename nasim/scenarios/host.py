...
class Host:
    ...
    def __init__(self,
        ...
        self.vul = vul #CBP
        self.c_tofind = c_tofind  #CBP3
        self.c_found = c_found    #CBP3
        self.c_needed = c_needed  #CBP3
    ...
    def __str__(self):
        ...
        output.append(f"\tc_found: {self.c_found}")   #CBP3
        output.append(f"\tc_needed: {self.c_needed}") #CBP3
        output.append(f"\tc_tofind: {self.c_tofind}") #CBP3
