...
class Scenario:
    ...
    def movement_time(self):
        return self.scenario_dict.get(u.MOVEMENT_TIME, None)
    ...
    @property
    def vul(self):
        return self.scenario_dict.get(u.VUL, [])
    ...
    def exploit_map(self):
        ...
        if self._e_map is None:
            ...
            for e_name, e_def in self.exploits.items():
                ...
                c_needed = e_def[u.EXPLOIT_CREDENTIALS_NEEDED]
                if c_needed not in srv_map3:
                    srv_map3[vul] = {
                        "name": e_name,
            ...
            for pe_name, pe_def in self.privescs.items():
                ...
                if os not in proc_map:
                    proc_map[os] = {
                        ...
                        u.PRIVESC_CREDENTIALS_TOFIND: pe_def[u.PRIVESC_CREDENTIALS_TOFIND] #CBP4
                    }
            self._pe_map = pe_map
        return self._pe_map
    ...
    @property
    def honeypots(self):
        return self.scenario_dict.get(u.HONEYPOTS, None)
    ...
    def get_action_space_size(self):
        ...
        num_vul = len(self.vul) #CBP2
        # OSScan, ServiceScan, SubnetScan, ProcessScan
        num_scans = 4
        actions_per_host = num_exploits + num_privescs + num_scans + num_vul #CBP2
    ...
    def get_description(self):
        description = {
            ...
            "Movement Time": self.movement_time #MT-T
        }
        return description
