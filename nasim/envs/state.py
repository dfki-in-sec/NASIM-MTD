...
class State:
    ...
    def get_initial_observation(self, fully_obs):
        ...
        for host_addr, host in self.hosts:
            if not host.reachable:
                continue
            host_obs = host.observe(reachable=True,  #CBP was True
                                    discovered=True) #CBP was True
    ...
    def get_observation(self, action, action_result, fully_obs):
        ...
        if action.is_exploit():
            ...
            obs_kwargs["vul"] = True #CBP
            obs_kwargs["c_needed"] = True # CBP3
            obs_kwargs["c_found"] = True  # CBP3
            obs_kwargs["os"] = True
            ...
            obs_kwargs["compromised"] = True
            obs_kwargs["access"] = True
            obs_kwargs["c_found"] = True  # CBP4
            obs_kwargs["c_tofind"] = True  # CBP4
            if action_result.value > 0:
                # Means exploit gained ROOT access for first time
                # So observe value
                obs_kwargs["value"] = True
        ...
        #CBP3
            ...
            obs_kwargs["c_found"] = True
            obs_kwargs["c_tofind"] = True
    ...
    Not needed
    #CBP3
    def get_credentail_tofind_value(self, host_address):
        return self.get_host(host_address).credetial_tofind
    """
