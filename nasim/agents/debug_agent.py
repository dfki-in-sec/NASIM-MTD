...
def debug_agent(env, render_mode="readable"):
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(6))
    print(ns)
    print(o)
    total_reward += r
    total_steps += 1
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(3))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(4))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(55))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(39))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(73))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(56))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(72))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(40))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
    ...
    total_reward = 0
    total_steps = 0
    ns, o, r, done, _ = env.generative_step(s, env.action_space.get_action(25))
    total_reward += r
    total_steps += 1
    print(LINE_BREAK2)
    print("NEXT STATE")
