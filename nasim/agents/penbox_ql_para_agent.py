...
class TabularQLearningAgent:
    ...
    def load(self):
        self.qfunc.set_q_func(np.load("runs/ql_agent_data.npy", allow_pickle=True).item())
...
def run(list):
    ### change paramter
    envs = ["s3_r_a_0.yaml","s3_r_a_1.yaml","s3_r_a_2.yaml","s3_r_a_3.yaml","s3_r_a_4.yaml","s3_r_a_5.yaml","s3_r_a_6.yaml","s3_r_a_7.yaml","s3_r_a_8.yaml","s3_r_a_9.yaml","s3_r_a_10.yaml","s3_r_a_11.yaml","s3_r_a_12.yaml","s3_r_a_13.yaml","s3_r_a_14.yaml","s3_r_a_15.yaml","s3_r_a_16.yaml","s3_r_a_17.yaml","s3_r_a_18.yaml","s3_r_a_19.yaml","s3_r_a_20.yaml","s3_r_a_21.yaml","s3_r_a_22.yaml","s3_r_a_23.yaml"]
    ...
    ql_agent = TabularQLearningAgent(
        ...
        seed=None,
        lr=float(list[0]),
        training_steps=2000000,  # default 10000  working well -> 200000
        final_epsilon=float(list[1]),  # default 0.05
        exploration_steps=int(list[2]),
        gamma=float(list[3]),
    ...
    env_list = []
    for env in list:
        env_list.append(nasim.load("../scenarios/benchmark/s1_rotation/" + env, flat_actions=True, flat_obs=True))
    ...
    ql_agent = TabularQLearningAgent(
        ...
        final_epsilon=0.05,  # default 0.05
    ...
    """
    ql_agent.train()
    print("Finished Training with" + str(list[0]) + "_" + str(list[1]) + "_" + str(list[2]) + "_" + str(list[3]))
    ql_agent.save()
...
if __name__ == "__main__":
    ...
    lr_list = [0.8, 0.5, 0.3, 0.1, 0.01, 0.001]
    final_epsilon_list =[0.8, 0.5, 0.3, 0.1, 0.01, 0.001]
    exploration_steps_list = [ 500, 10000, 50000, 100000, 150000, 200000] # for 200000 train steps
    gamma_list = [0.1, 0.4, 0.7, 0.9, 0.99, 0.999]
        ...
        for final_epsilon in final_epsilon_list:
            for exploration_steps in exploration_steps_list:
                for gamma in gamma_list:
                    para_list.append([lr, final_epsilon, exploration_steps, gamma])
    ...
    # Best Parameter Found Scenario 1:
    #para_list = [['0.8', '0.8', '500', '0.9'], ['0.01', '0.001', '500', '0.4'], ['0.01', '0.01', '10000', '0.4'], ['0.3', '0.001', '10000', '0.999'], ['0.3', '0.001', '500', '0.99'], ['0.01', '0.001', '10000', '0.9'], ['0.3', '0.01', '10000', '0.999'], ['0.5', '0.001', '500', '0.99'], ['0.01', '0.01', '10000', '0.999'], ['0.1', '0.5', '150000', '0.7'], ['0.01', '0.01', '500', '0.7'], ['0.1', '0.3', '150000', '0.1'], ['0.5', '0.001', '500', '0.999'], ['0.01', '0.001', '500', '0.999'], ['0.3', '0.001', '500', '0.999'], ['0.1', '0.01', '10000', '0.99'], ['0.1', '0.01', '500', '0.999'], ['0.01', '0.01', '500', '0.9'], ['0.01', '0.1', '500', '0.7'], ['0.01', '0.001', '500', '0.9'], ['0.1', '0.001', '500', '0.999'], ['0.01', '0.1', '500', '0.4'], ['0.01', '0.001', '50000', '0.99'], ['0.3', '0.8', '50000', '0.7']]
    # Best Parameter Found Scenario 2:
    #para_list = [['0.3', '0.3', '150000', '0.999'], ['0.01', '0.3', '50000', '0.7'], ['0.01', '0.5', '10000', '0.7'], ['0.01', '0.01', '200000', '0.999'], ['0.1', '0.3', '50000', '0.99'], ['0.1', '0.3', '150000', '0.9'], ['0.01', '0.3', '10000', '0.999'], ['0.1', '0.8', '50000', '0.999'], ['0.3', '0.5', '500', '0.99'], ['0.5', '0.3', '200000', '0.4'], ['0.01', '0.3', '200000', '0.999'], ['0.01', '0.3', '10000', '0.4'], ['0.01', '0.001', '200000', '0.99'], ['0.01', '0.001', '200000', '0.9'], ['0.01', '0.5', '200000', '0.4'], ['0.01', '0.5', '150000', '0.999'], ['0.01', '0.8', '10000', '0.999'], ['0.1', '0.3', '50000', '0.7'], ['0.5', '0.3', '10000', '0.7'], ['0.3', '0.01', '100000', '0.4'], ['0.1', '0.3', '500', '0.99'], ['0.5', '0.1', '500', '0.99'], ['0.01', '0.001', '150000', '0.999'], ['0.1', '0.3', '200000', '0.999']]
    """
    # Best Parameter Found Scenario 3:
    para_list = [['0.8', '0.8', '500', '0.9'], ['0.1', '0.5', '10000', '0.4'], ['0.01', '0.3', '500', '0.4'], ['0.01', '0.01', '50000', '0.7'], ['0.01', '0.1', '50000', '0.4'], ['0.1', '0.1', '100000', '0.4'], ['0.1', '0.5', '150000', '0.7'], ['0.01', '0.001', '150000', '0.7'], ['0.01', '0.001', '100000', '0.9'], ['0.01', '0.001', '500', '0.7'], ['0.01', '0.1', '10000', '0.7'], ['0.01', '0.001', '50000', '0.7'], ['0.01', '0.01', '100000', '0.9'], ['0.01', '0.01', '500', '0.7'], ['0.01', '0.01', '50000', '0.9'], ['0.01', '0.01', '10000', '0.7'], ['0.01', '0.3', '100000', '0.7'], ['0.01', '0.01', '100000', '0.4'], ['0.1', '0.5', '10000', '0.7'], ['0.3', '0.1', '500', '0.99'], ['0.1', '0.5', '500', '0.9'], ['0.5', '0.001', '10000', '0.9'], ['0.01', '0.3', '10000', '0.4'], ['0.01', '0.01', '10000', '0.99']]

    """ 
    for idx,elem in enumerate(envs):
        #para_list.append([elem])
        if idx%3 == 0:
            para_list.append(["s3_r_a_0.yaml", "s3_r_a_1.yaml", "s3_r_a_2.yaml"])
        elif idx%3 == 1:
            para_list.append(["s3_r_a_0.yaml", "s3_r_a_1.yaml"])
        else:
            para_list.append(["s3_r_a_0.yaml"])
        #para_list.append(envs)
    """
