...
class TabularQLearningAgent:
    ...
    def __init__(self,
        ...
        #self.num_actions = 208 # 12 hosts -> from testt 1
        #self.num_actions = 208  # 12 hosts -> from testt 1
        #self.obs_dim = (602, ) # 12 hosts -> from testt 1
        # logger setup
    ...
    def save(self):
        np.save("runs/ql_agent_data.npy", self.qfunc.q_func)
...
if __name__ == "__main__":
    ...
    """
    #Parameter
    #testt = ["penbox_traint_1_static.yaml", "penbox_traint_2_static.yaml", "penbox_traint_5_static.yaml", "penbox_traint_4_static.yaml"]
    ...
    #eval_set = ["penbox_traint_5_static.yaml", "penbox_traint_6_static.yaml", "penbox_traint_2_static.yaml"]
    #eval_set = ["penbox_traint_1.yaml", "penbox_traint_2.yaml", "penbox_traint_3.yaml","penbox_traint_4.yaml", "penbox_traint_5.yaml"]

    env_list = []
    for env in testt:
        env_list.append(nasim.load("../scenarios/benchmark/"+env, flat_actions=True, flat_obs=True))
    #print("self.num_actions",env_list[0].action_space.n)
    #print("self.obs_dim",env_list[0].observation_space.shape)
