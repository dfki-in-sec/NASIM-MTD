...
def run(list):
    ...
    ql_agent.logger = SummaryWriter(comment=str(0) + str(list[0]) + "_" + str(list[1]) + "_" + str(list[2]) + "_" + str(list[3]))
    ql_agent.train()
    for idx,env in enumerate(envs[1:]):
        ql_agent.logger= SummaryWriter(comment=str(idx + 1) + str(list[0]) + "_" + str(list[1]) + "_" + str(list[2]) + "_" + str(list[3]))
        ql_agent.env = env
        ql_agent.train()
    ql_agent.save()
